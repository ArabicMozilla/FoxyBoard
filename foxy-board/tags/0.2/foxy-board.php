<?php  
    ...
    Plugin URI: http://blog.nefzaoui.com/ 
    Version: 0.2
    ...
    */  
	...
	.'<div class="fx-single-app-picture"><img src="'.$fx_single_app->image_assets->desktop_tile[0].'"/></div>'
	...
	.'<img id="mysingleappqr" onclick="this.style=&#39;none&#39;" class="the-qr" src="http://api.qrserver.com/v1/create-qr-code/?size=130x130&data='.$single_app_url.'"></img>'
	.'</div>';
	...
	static function playboard_box_init() {
        add_meta_box('playboard_box_init', 'Foxy Board Widget', 'foxy_board_widget', 'post', 'side', 'high');
    }
	...
	static function register_all(){
				...
				add_action('admin_menu', array(__CLASS__,'playboard_box_init'));
				add_shortcode('firefox-app',array(__CLASS__,handle_fx_app_preview));
